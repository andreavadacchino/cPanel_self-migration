...
export default function ComparisonPanel({
  ...
  return (
    <section className="panel">
      ...
      {!report && !error && (
        <p className="hint">
          Confronta l'inventario di sorgente e destinazione per vedere cosa
          manca, cosa è diverso e cosa può bloccare una migrazione futura. Serve
          un preflight completato su entrambi gli endpoint.
        </p>
      )}
