# Task C1: Website content transfer
...
| **Size** | L |
| **Dependencies** | B2, B3 |
| **Branch** | `feat/c1-website-content-transfer` |

**Goal:** Add a safe tar/stream transfer plan with guarded destination paths, exclusions, progress, manifest, and non-destructive default behavior.

**Current State:** The V2 planner and writers do not transfer website docroots.
...
- [ ] path escape/symlink attacks fail; interrupted copy is retryable; source remains read-only.
